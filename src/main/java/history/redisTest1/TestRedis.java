...
public class TestRedis {
	...
	private static final String SERVER_ADDRESS = "192.168.178.1"; // 服务器地址
	...
	public void testHash() {
		...
		System.out
				.println("========================del no============================="+no);
		jedis.del("car:01","NO","京88884");
		Map<String, String> result1 = jedis.hgetAll("car:01");
		Iterator<Entry<String, String>> it1 = result1.entrySet().iterator();
		while (it.hasNext()) {
